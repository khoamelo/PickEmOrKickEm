...
const Head2HeadGames = () => {
  ...
  // State for selected stat, prop line, and opposing team
  const [selectedStat, setSelectedStat] = useState('');
  const [propLine, setPropLine] = useState('');
  const [oppTeam, setOppTeam] = useState('');

  // Handle form submission to fetch head-to-head data and navigate to results
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // Navigate to results page, passing player data, H2H data, and respective chosen stats in state
      navigate('/results', {
        state: {
          playerData,
  ...
  return (
    <div className='text-xl flex flex-col items-center justify-center gap-4 h-screen bg-gradient-to-b from-blue-900 to-black text-white'>
      ...
      {/* Form for selecting stat, prop line, and opposing team */}
